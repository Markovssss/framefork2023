...
public class Hotel extends BaseClass {
	...
	public void HotelBooking() {
		...
		inputText(txtUserName, "manojvk97@gmail.com");

		WebElement txtPassword = locateById("pass");
		inputText(txtPassword, "manojVK@97");
		...
		click(txtDate);
		WebElement selectDate = locateByXpath("//a[text()='15']");
		click(selectDate);
		...
		WebElement txtFrame = locateById("hotelsearch_iframe");
		frameByWebElement(txtFrame);

		WebElement btnSearch = locateByXpath("//button[text()='Search']");
		click(btnSearch);
